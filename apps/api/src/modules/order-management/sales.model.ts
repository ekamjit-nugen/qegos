...
export async function seedSalesCatalogue(SalesModel: Model<ISalesDocument>): Promise<void> {
  const services: Array<Partial<ISalesDocument>> = [
    {
      title: 'Individual Tax Return (simple)',
      price: 9900,
      gstInclusive: true,
      gstAmount: 900,
      category: 'individual',
    ...
    {
      title: 'Individual Tax Return (complex)',
      price: 27500,
      gstInclusive: true,
      gstAmount: 2500,
      category: 'individual',
    ...
    {
      title: 'Capital Gains Tax Schedule',
      price: 8800,
      gstInclusive: true,
      gstAmount: 800,
      category: 'investment',
    ...
    {
      title: 'BAS Preparation (quarterly)',
      price: 16500,
      gstInclusive: true,
      gstAmount: 1500,
      category: 'business',
    ...
    {
      title: 'PAYG Instalment Variation',
      price: 5500,
      gstInclusive: true,
      gstAmount: 500,
      category: 'business',
